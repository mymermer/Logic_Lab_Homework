...
HD_PWD='C:/Users/myusu/Documents/blg242/HW/HW.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log prelim_1_d.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source prelim_1_d.tcl -notrace
